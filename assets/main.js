...
function typeSignature() {
    typeSignature.count = typeSignature.count || 0, typeSignature.count <= signature.length ? (signatureEl.innerHTML = "".concat(signature.slice(0, typeSignature.count++), "|"), setTimeout(typeSignature, 100)) : signatureEl.innerHTML = signature
}
